...
rule concat_fractions_sr:
    input:
        bac_fq1=expand(
            "results/fractions/short_reads/{bac_ref}_{{p}}_1.fastq",
            bac_ref=bacteria.bacteria,
        ),
        bac_fq2=expand(
            "results/fractions/short_reads/{bac_ref}_{{p}}_2.fastq",
            bac_ref=bacteria.bacteria,
        ),
...
rule compare_results_sr:
    input:
        sourmash=expand(
            "results/sourmash/sr/lca-class/Scaled_2000_mixed_sample{n}_{p}_R1.csv",
        ...
        fq=expand(
            "results/mixed_sr/mixed_{p}_Sample{n}_1.fastq",
            n=range(1, config["number_of_samples"] + 1),
            p=config["p"],
        ),
    output:
        report(
            ...
            caption="../report/comparison_plot.rst",
        ),
        report(
...
rule compare_results_lr:
    input:
        sourmash=expand(
            "results/sourmash/lr/lca-class/Scaled_2000_mixed_sample{n}_{p}_k21.csv",
            n=range(1, config["number_of_samples"] + 1),
            p=config["p"],
        ),
        kraken2=expand(
