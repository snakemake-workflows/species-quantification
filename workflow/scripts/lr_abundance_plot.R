...
for (i in snakemake@input[["sourmash"]]){
  ...
  total_n <- setNames(c(51925, 79925, 114925, 149925),
                      c("results/sourmash/lr/lca-class/Scaled_2000_mixed_sample1_1000_k21.csv",
                        "results/sourmash/lr/lca-class/Scaled_2000_mixed_sample1_5000_k21.csv",
                        "results/sourmash/lr/lca-class/Scaled_2000_mixed_sample1_10000_k21.csv",
                        "results/sourmash/lr/lca-class/Scaled_2000_mixed_sample1_15000_k21.csv"))
...
for (j in snakemake@input[["kraken2"]]){
  ...
  #BU KISMI SOR!
  total_n <- setNames(c(51925, 79925, 114925, 149925),
                      c("results/kraken2/lr/sb/evol1_Sample1_fraction1000",
                        "results/kraken2/lr/sb/evol1_Sample1_fraction5000",
                        "results/kraken2/lr/sb/evol1_Sample1_fraction10000",
                        "results/kraken2/lr/sb/evol1_Sample1_fraction15000"))
...
for (k in snakemake@input[["bracken"]]){
  ...
  #BU KISMI SOR!
  total_n <- setNames(c(51925, 79925, 114925, 149925),
                      c("results/bracken/lr/sb/evol1_Sample1_fraction1000.bracken",
                        "results/bracken/lr/sb/evol1_Sample1_fraction5000.bracken",
                        "results/bracken/lr/sb/evol1_Sample1_fraction10000.bracken",
                        "results/bracken/lr/sb/evol1_Sample1_fraction15000.bracken"))
